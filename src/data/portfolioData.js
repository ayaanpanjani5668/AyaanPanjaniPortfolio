...
export const athletics = [
  {
    ...
    years: 'Grades 11–12',
    icon: 'soccer',
    accomplishments: ['16 weeks/year season commitment'],
    learned:
  ...
  },
  {
    ...
    years: 'Grades 9–12',
    icon: 'soccer',
    accomplishments: ['35 weeks/year — year-round commitment'],
  ...
  },
  {
    ...
    years: 'Grade 11',
    icon: 'bolt',
    accomplishments: ['14 weeks/year season'],
